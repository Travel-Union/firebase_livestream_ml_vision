...
class MlKitFlutter extends ValueNotifier<CameraValue> {
  static const MethodChannel channel = const MethodChannel('ml_kit_flutter');
  ...
  MlKitFlutter(this.device, this.resolution)
  ...
  initializeStream() {
    _subscription = EventChannel('ml_kit_flutter/events')
  ...
  Stream<dynamic> subscribe() {
    return EventChannel('ml_kit_flutter/events')
        .receiveBroadcastStream()
        .map((event) {
      try {
